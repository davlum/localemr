...
class Configuration:
    ...
    def __init__(self):
        self.exec_impl = os.environ.get('LOCALEMR_EXEC_IMPL', 'livylike')
        ...
        self.localemr_container_repo = os.environ.get('LOCALEMR_CONTAINER_REPO', 'davlum/localemr-container:v0.1.2-spark')
